    ...
    return donations.map((donation) => ({
      ...
      fundraiser: donation.fundraiser
        ? {
            ...
            slug: donation.fundraiser.slug,
            title: donation.fundraiser.title,
            targetAmountPence: donation.fundraiser.targetAmountPence,
            plaqueName: donation.fundraiser.plaqueName,
          }
        : null,
      fundraiserTotalRaisedPence: donation.fundraiserId ? totalsByFundraiser[donation.fundraiserId] ?? 0 : null,
      fundraiserTargetMet:
        donation.fundraiser != null &&
        donation.fundraiser.targetAmountPence != null &&
        (totalsByFundraiser[donation.fundraiserId!] ?? 0) >= donation.fundraiser.targetAmountPence,
    }))
  } catch (error) {
...
export default async function WaterPumpsDonationsPage({
  ...
  return (
    <>
      <AdminHeader title="Water Pumps - Donations" />
