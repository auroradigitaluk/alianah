...
const appealSchema = z.object({
  ...
  allowDailyGiving: z.boolean().optional().default(false),
  showOnDonationForm: z.boolean().optional().default(true),
  showOnZakatPage: z.boolean().optional().default(true),
  ...
  try {
    ...
    const appeal = await prisma.appeal.create({
      data: {
        ...
        allowDailyGiving: data.allowDailyGiving ?? false,
        showOnDonationForm: data.showOnDonationForm ?? true,
        showOnZakatPage: data.showOnZakatPage ?? true,
