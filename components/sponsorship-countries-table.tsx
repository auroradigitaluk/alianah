...
import { IconUsersGroup, IconMapPin } from "@tabler/icons-react"
...
export function SponsorshipCountriesTable({ countries }: { countries: SponsorshipCountry[] }) {
  const [selectedCountry, setSelectedCountry] = useState<SponsorshipCountry | null>(null)
  ...
  const groupedCountries = countries.reduce((acc, country) => {
    ...
    return acc
  }, {} as Record<string, SponsorshipCountry[]>)
      ...
      >
        <DialogContent className="max-w-4xl h-[90vh] overflow-hidden flex flex-col p-0 shadow-2xl">
          <DialogHeader className="px-6 pt-6 pb-4 border-b">
            ...
            <DialogDescription>
              Sponsorship country information and settings
            </DialogDescription>
          </DialogHeader>
              ...
              <Tabs defaultValue="overview" className="flex-1 flex flex-col overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto px-6 py-6">
                  <TabsContent value="overview" className="space-y-6 mt-0">
                    ...
                    <div className="pt-2">
                      <a
                        href={`/admin/sponsorships/countries/${selectedCountry.id}/edit`}
